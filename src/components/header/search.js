...
const HeaderSearch = ({ onClick }) => {
  return (
    <div className={style.main}>
              ...
              <div className="d-flex flex-column">
                <div className="d-flex align-items-center">
                  ...
                  <div className="destination d-flex justify-content-between ms-3 w-100">
                    <div className="from text-start mx-3">
                      <p>From</p>
                      <h5 className="mt-1 ">
                        <input
                          type="text"
                ...
                <div>
                  <small className="me-1" style={{ marginLeft: "80px" }}>
                    Monday.20 july 20
                  </small>
                  <svg
                    width="5"
                  ...
                  <small className="mx-1">Economy</small>
                </div>
              </div>
            </div>
          </div>
      ...
      <div
        className={`${style.right} col-12 d-flex flex-row-reverse bd-highlight`}
      >
